        ...
        <div class="row justify-content-md-between mb-6 amatic-r">
                        ...
                        <form>
                            <div class="d-grid gap">
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control" name="message" id="message" placeholder="Писать тут..."
                                        rows="4"></textarea>
                                </div>
                                <div class="d-grid">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="media mb-4 d-flex">
                    <div class="ui-icon ui-icon-sm rounded-circle mx-0 flex-shrink-0 ui-icon-click"
                        data-copy="gleb.stop@gmail.com">
