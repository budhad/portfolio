    ...
    <section class="min-h radius-half spacer-xl-top spacer-xl-bottom position-relative background-queen_main">
        ...
        <div class="row align-items-center position-relative">
            <div class="col-md-6 col-lg-6 text-left mb-4 mb-lg-0">
                <h1 class="fs-0 font-weight-700 mb-0 text-uppercase amatic shadow_blue">Глеб Стопудов
                </h1>
                <p class="mb-0 lead amatic shadow_green">Разработчик чудесатого.</p>
            ...
            <div class="col-lg-6 col-md-6 ">
                <div class="profile-image">
                    <div class="position-relative">
                        ...
                        <a href="#"
                            class="btn right-5 bottom-5 text-uppercase btn-info position-absolute shadow-double fs-5 z-index-1 ps-4 btn-lg amatic">
                    ...
                    <div class="abstract-shape d-lg-block d-none">
                        ...
                        <svg class="position-absolute p3 scale-move" data-name="circle" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 43.76 43.08">
                            <path class="circle"
                        ...
                        <svg class="position-absolute p5 bottom-move" data-name="half-circle "
                            ...
                            <defs>
                                <linearGradient id="linear-gradient" x1="20.51" y1="42.35" x2="170.58" y2="42.35"
                                    gradientTransform="translate(170.58 117.09) rotate(180)" gradientUnits="userSpaceOnUse">
