                ...
                <div class="col-lg-6 mb-5 mb-lg-0 ">
                    <div class="main-info ">
                        <ul class="list-inline mb-0">
                            ...
                            <li><span class=" font-weight-600 me-1">E-mail: </span><a
                                    href="mailto:gleb.stop@gmail.com">gleb.stop@gmail.com</a></li>
                            <li><span class="font-weight-600 me-1">Телефон: </span><a href="tel:79892214783">+7 (989)
                                    221-47-83</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-5 mb-lg-6">
                    <div class="timeline">
                        ...
                        <div class="res-block  timeline-content mb-4">
                            <div class="mb-3 res-block-inner edc">
                                <div class="media align-items-center d-flex justify-content-between">
                                    <h6 class="font-weight-600 font-size-14 mb-0">Магнитогорский политехнический техникум<span
                                            class="font-size-13 mt-1 text-alt-2 d-block font-weight-400"> 2004 — 2007 </span>
                                    </h6>
                                    <div class="media-body text-right">
                                        <span class="badge badge-line-1-1 rounded-pill border border-danger">3</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="res-block timeline-content mb-4">
                            <div class="mb-3 res-block-inner edc">
                                <div class="media align-items-center d-flex justify-content-between">
                                    <h6 class="font-weight-600 font-size-14 mb-0">Магнитогорский государственный университет (Не
                                        окончен)<span class="font-size-13 mt-1 text-alt-2 d-block font-weight-400"> 2008 — 2011
                                        </span> </h6>
                                    <div class="media-body text-right">
                                        <span class="badge badge-line-1-1 rounded-pill border border-danger">2</span>
                                    </div>
                                </div>
                            </div>
                            <p class="mb-0 ">Факультет информатики, Математическое обеспечение и администрирование
                    ...
                    <div class="timeline">
                        ...
                        <div class="res-block timeline-content">
                            <div class="mb-3 res-block-inner exp">
                                <div class="media align-items-center d-flex justify-content-between">
                                    <h6 class="font-weight-600 font-size-14 mb-0">РУГРУП<span
                                            class="font-size-13 mt-1 text-alt d-block font-weight-400"> 2020 — 2023 </span>
                                    </h6>
                                    <div class="media-body text-right">
                                        <span class="badge badge-line-1-1 rounded-pill border border-danger">3</span>
                                    </div>
                        ...
                        <div class="res-block timeline-content mb-4">
                            <div class="mb-3 res-block-inner exp">
                                <div class="media align-items-center d-flex justify-content-between">
                                    <h6 class="font-weight-600 font-size-14 mb-0">Самозанятый Web-разработчик<span
                                            class="font-size-13 mt-1 text-alt d-block font-weight-400"> 2019 — 2020 </span>
                                    </h6>
                                    <div class="media-body text-right">
                                        <span class="badge badge-line-1-1 rounded-pill border border-danger">1</span>
                                    </div>
                                </div>
                            </div>
                            <p class="mb-0">Хорошее знание структуры Wordpress + Woocommerce, создание шаблонов с 0 <br />
                                ...
                                <br />
                                Кроссбраузерная адаптивная верстка, на flex-box \ grid, современной анимации (CSS3,
                                jQuery).<br />
                                <br />
                                Составление robot.txt, sitemaps, редиректов, htaccess, настройка хостинга, домена,
                                ssl-сертификатов.<br />
                                Верстка по макетам PSD, владение Photoshop, Illustrator, Figma.<br />
                            </p>
                        </div>
                        <div class="res-block timeline-content mb-4">
                            <div class="mb-3 res-block-inner exp current">
                                <div class="media align-items-center d-flex justify-content-between">
                                    <h6 class="font-weight-600 font-size-14 mb-0">Без организации<span
                                            class="font-size-13 mt-1 text-alt d-block font-weight-400"> 2012 — 2014 </span>
                                    </h6>
                                    <div class="media-body text-right">
                                        <span class="badge badge-line-1-1 rounded-pill border border-danger">2</span>
                                    </div>
                            ...
                            <p class="mb-0 ">Разработка и создание автоматизированной системы для школ, включающей в себя:
                                автоматизированны комплекс по приему платежей населения через терминалы, электронные системы
                                оплаты в пользу образовательных учреждений, ведение эелктронного дневника, идентификационная
                                система учета посещений в школах, основанная на RFID картах и считывателях (без турникетов -
                                чтобы избежать столкновений с пожарниками).<br /><br />Система школьного питания в буфете по
                                идентификационным картам (У каждого пользователя существует внутри системы указатель на лицевой
                                баланс, относительно которго он попадает \ не попадает в "школьную" заявку ежедневную заявку на
                                питание (если карта была зарегестрирована на входе до начала формирования заявки) автоматическое
                                уведомление родителей о событиях в системе : состояние баланса, перемещение карты, питание.
                                <br /><br /> Delphi HTML PHP XML ADO DBE MySQL Access Drupal WordPress Joomla FastReport
                            </p>
                        </div>
                        <div class="res-block timeline-content mb-4">
                            <div class="mb-3 res-block-inner exp">
                                <div class="media align-items-center d-flex justify-content-between">
                                    <h6 class="font-weight-600 font-size-14 mb-0">ООО ИТ-Компания "Сайк"<span
                                            class="font-size-13 mt-1 text-alt d-block font-weight-400"> 2009 — 2010 </span>
                                    </h6>
                                    <div class="media-body text-right">
                                        <span class="badge badge-line-1-1 rounded-pill border border-danger">1</span>
                                    </div>
                            ...
                            <p class="mb-0">Разработка комплекса GPS навигации для автопарка. Обработка данных, работа с
                                графикой, MySQL, delphi, FastReport</p>
                        </div>
                        <div class="res-block timeline-content">
                            <div class="mb-3 res-block-inner exp">
                                <div class="media align-items-center d-flex justify-content-between">
                                    <h6 class="font-weight-600 font-size-14 mb-0">ЗАО "Андроидные роботы"
                                        Инженер-программист<span class="font-size-13 mt-1 text-alt d-block font-weight-400">
                                            2007 — 2008 </span> </h6>
                                    <div class="media-body text-right">
                                        <span class="badge badge-line-1-1 rounded-pill border border-danger">1</span>
                                    </div>
                            ...
                            <p class="mb-0 ">Создание программного обеспечение для андроидных роботов: беспроводное управление,
                                система координирования движений.</p>
                        </div>
                    </div>
                </div>
            </div>
